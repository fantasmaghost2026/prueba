      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {adminState.novels?.filter(novel => novel.estado === 'transmision').length > 0 && (
          <section className="mb-12">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-gray-900 flex items-center">
                <div className="bg-red-500 p-2 rounded-lg mr-3 shadow-lg">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
              {adminState.novels
                ...
                .map((novel) => (
                  <Link
                    to={`/novel/${novel.id}`}
                    key={`novel-transmision-${novel.id}`}
                  ...
                  >
                    <div className="relative">
                      ...
                      <div className="absolute top-2 left-2">
                        <span className="px-2 py-1 rounded-full text-xs font-bold text-white shadow-lg bg-red-500 animate-pulse">
                          📡 EN VIVO
                        </span>
                      </div>
                    ...
                    <div className="p-3 sm:p-4">
                      ...
                      <div className="flex flex-col space-y-2 text-xs text-gray-600 mb-3">
                        <span className="bg-red-100 text-red-700 px-2 py-1 rounded-full text-center font-medium">
                          {novel.genero}
                        </span>
            ...
            <div className="text-center mt-8">
              ...
              <p className="text-sm text-gray-600 mt-3 max-w-md mx-auto">
                {adminState.novels?.filter(novel => novel.estado === 'transmision').length || 0} novelas actualmente en transmisión
              </p>
            </div>
          </section>
        )}
        ...
        {adminState.novels?.filter(novel => novel.estado === 'finalizada').length > 0 && (
          <section className="mb-12">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-gray-900 flex items-center">
                <div className="bg-green-500 p-2 rounded-lg mr-3 shadow-lg">
                  <span className="text-white text-lg">✅</span>
                </div>
                Novelas Finalizadas
              </h2>
                ...
                .map((novel) => (
                  ...
                  >
                    <div className="relative">
                      ...
                      />
                      <div className="absolute top-2 left-2">
                        <span className="px-2 py-1 rounded-full text-xs font-bold text-white shadow-lg bg-green-500">
                          ✅ COMPLETA
                        </span>
                      </div>
                      <div className="absolute top-2 right-2">
                    ...
                    <div className="p-3 sm:p-4">
                      ...
                      <div className="flex flex-col space-y-2 text-xs text-gray-600 mb-3">
                        <span className="bg-green-100 text-green-700 px-2 py-1 rounded-full text-center font-medium">
                          {novel.genero}
                        </span>
                        <span className="bg-blue-100 text-blue-700 px-2 py-1 rounded-full text-center font-medium">
                          {getCountryFlag(novel.pais || 'No especificado')} {novel.pais || 'No especificado'}
        ...
        {adminState.novels?.filter(novel => novel.estado === 'finalizada').length > 0 && (
          <section className="mb-12">
            ...
            <div className="text-center mt-8">
              ...
              <p className="text-sm text-gray-600 mt-3 max-w-md mx-auto">
                {adminState.novels?.filter(novel => novel.estado === 'finalizada').length || 0} novelas finalizadas disponibles
              </p>
